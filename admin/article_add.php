...
if($_POST)
{
    ...
    $insertId = insertData("article",$data);

    if(!$insertId)
    {
        @show_msg('插入文章失败','article_add.php');
        exit;
    }
    ...
    {
        @show_msg('插入文章成功','article_list.php');
        exit;
    }
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form class="article_add" action="#" method="post" enctype="multipart/form-data">
            <label>文章标题</label>
            <input type="text" datatype="s4-25" value="" name="art_title" class="input-xxlarge">
             <label>小标题</label>
            <input type="text" value="" name="art_stitle" class="input-xxlarge">
            <label>发布时间</label>
            <input type="date" value="<?php echo date("Y-m-d");?>" name="art_time" class="input-xxlarge">
            <label>文章作者</label>
            <input type="text" datatype="s2-10" value="" name="art_author" class="input-xxlarge">
            <label>文章图片</label>
            ...
            <div id="tag_list"></div>
             <label>基本信息</label>
            <textarea value="Smith" name="art_message" rows="3" class="input-xxlarge"></textarea>
            <label>文章内容</label>
            <textarea value="Smith" name="art_content" rows="3" class="input-xxlarge"></textarea>
            <label></label>
