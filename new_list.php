        ...
        <div class="cms-g">
            <div class="am-hide-sm-only am-u-md-3 am-u-lg-3">
                <div class="com-nav-left">
                   ...
                   <?php foreach($tag_list as $item){?>
                    <ul>
                        <li class="<?php echo $tag_id==$item['tag_id'] ? "on":"";?>"><a href="new_list.php?tag_id=<?php echo $res=$item['tag_id'];?>"><?php echo $item['tag_name'];?></a></li>
                    </ul>
                    <?php }?>
                </div>
            </div>
            <div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
                ...
                <div class="new-list">
                    ...
                    <ul>
                        <li><a href="new_info.php?tag_id=<?php echo $tag_id;?>&art_id=<?php echo $item['art_id'];?>"><span><?php echo $item['art_title'];?></span><em><?php echo date("Y-m-d",$item['art_time']);?></em></a></li>
                    </ul>
                    <?php }?>
                </div>
                <div class="page-list">
